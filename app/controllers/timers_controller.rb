class TimersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @timer.save
        format.html { redirect_to timers_url, notice: 'Timer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @timer.update(timer_params)
        format.html { redirect_to timers_url, notice: 'Timer was successfully updated.' }
  ...
  private
    ...
    def timer_params
      params.require(:timer).permit(:name, :minutes)
    end
end
